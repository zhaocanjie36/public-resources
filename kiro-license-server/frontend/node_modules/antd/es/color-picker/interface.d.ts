...
export type ColorPickerClassNamesType = SemanticClassNamesType<ColorPickerProps, ColorPickerSemanticClassNames, {
    popup?: {
        root?: string;
    };
}>;
export type ColorPickerStylesType = SemanticStylesType<ColorPickerProps, ColorPickerSemanticStyles, {
    popup?: {
        root?: React.CSSProperties;
    };
